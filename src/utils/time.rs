...
/// Converts a `SystemTime` to a human-readable timestamp string in the format
/// "HH:MM:SS".
///
/// # Parameters
/// - `when`: A reference to a `SystemTime` instance representing the time to be
...
/// Converts a `SystemTime` to a human-readable datestamp string in the format
/// "YYYY-MM-DD HH:MM:SS".
///
/// # Parameters
/// - `when`: A reference to a `SystemTime` instance representing the time to be
///   converted to a datestamp string.
///
/// # Returns
